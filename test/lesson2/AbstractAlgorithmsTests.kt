...
abstract class AbstractAlgorithmsTests {
    ...
    fun longestCommonSubstring(longestCommonSubstring: (String, String) -> String) {
        ...
        assertEquals("'9sta", longestCommonSubstring("'7'9start", "56st'9stawen "))
        assertEquals("ривет, ", longestCommonSubstring("Привет, как дела?", "привет, Как ты?!?"))
        assertEquals("y^:qwerty", longestCommonSubstring("qwerty^:qwerty", "qwerTy^:qwerty"))
        assertEquals("qwerty^:qwerty", longestCommonSubstring("qwerty^:qwerty", "qwerty^:qwerty"))
        assertEquals("СЕРВАТОР", longestCommonSubstring("ОБСЕРВАТОРИЯ", "КОНСЕРВАТОРЫ"))
        assertEquals("Мне бы только смотреть на тебя,\n" +
                "Видеть глаз злато-карий омут,\n" +
                "И чтоб, прошлое не любя,\n" +
                "Ты уйти не смогла к другому.", longestCommonSubstring("Мне бы только смотреть на тебя,\n" +
                "Видеть глаз злато-карий омут,\n" +
                "И чтоб, прошлое не любя,\n" +
                "Ты уйти не смогла к другому.", "Заметался пожар голубой,\n" +
                ...
                "В первый раз я запел про любовь,\n" +
                "В первый раз отрекаюсь скандалить.\n"))
        assertEquals("ходи из комнаты, не совершай ошибку.\n" +
                ...
                "     шкафом от хроноса, космоса, эроса, расы, вируса.", longestCommonSubstring("Не выходи из комнаты, не совершай ошибку.\n" +
                "     Зачем тебе Солнце, если ты куришь Шипку?\n" +
                "     За дверью бессмысленно вс?, особенно -- возглас счастья.\n" +
                "     Только в уборную -- и сразу же возвращайся.\n" +
                "\n" +
                ...
                "     Не выходи из комнаты! То есть дай волю мебели,\n" +
                "     слейся лицом с обоями. Запрись и забаррикадируйся\n" +
                "     шкафом от хроноса, космоса, эроса, расы, вируса.", "Не уходи из комнаты, не совершай ошибку.\n" +
                "     Зачем тебе Солнце, если ты куришь Шипку?\n" +
                "     За дверью бессмысленно вс?, особенно -- возглас счастья.\n" +
                "     Только в уборную -- и сразу же возвращайся.\n" +
                "\n" +
